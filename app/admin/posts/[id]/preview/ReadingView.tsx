...
const ReadingView = ({ article, relatedArticles, categories, tags, id, showSidebar }: ReadingViewProps) => {
  const toggleHref = showSidebar ? `/admin/posts/${id}/preview?reading_mode=1` : `/admin/posts/${id}/preview`;

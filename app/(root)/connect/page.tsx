...
export default async function Page() {
    return (
        <main className={`max-w-4xl mx-auto pt-8 pb-4 px-4`}>
            ...
            <p className={`font-med md:text-md lg:text-md lg:mb-8 mb-6 text-muted-foreground`}>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 md:gap-8`}>
                ...
                <div className={`py-4 lg:py-16`}>
                    <div className={`p-6 mb-8 rounded-lg border-2 border-y-secondary border-x-primary`}>
                        <h3 className={`text-medium sm:text-2xl font-bold w-full pb-4`}>{'Social'}</h3>
                        <div className={`flex justify-around`}>
                            <Link href={`https://www.linkedin.com/in/yogesh-bisht-83167a201/`} target="_blank" aria-label="Go to Linkedin Profile">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 mx-auto fill-foreground" role="img" viewBox="0 0 448 512">
                                    <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                                </svg>
                            </Link>
                            <Link href={`https://www.instagram.com/yogesh.bisht.99/`} target="_blank" aria-label="Go to Instagram page">
                                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" className="w-8 mx-auto fill-foreground" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <Link href={`https://github.com/YogeshBisht2307`} target="_blank" aria-label="Go to Github Page">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 mx-auto fill-foreground" role="img" viewBox="0 0 500 550">
